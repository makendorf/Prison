...
namespace Network
{
    public class Global
    {
        ...
        private static Dictionary<Shop, string> _shopMap = new Dictionary<Shop, string>()
        {
            {Shop.Shop1,  "3c36ce5f-c743-45ef-83e6-d7eb5d8a47e4"},
            {Shop.Shop2, "f1492bb8-6304-499c-ae89-8726428fba19" },

        };

        public static string GetGUID(Shop shop)
        {
            return _shopMap[shop];
            //switch (shop)
            //{
            //    case Shop.Shop1:
